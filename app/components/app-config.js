...
template.innerHTML = `
<style>
    @import "/anywhere-ui-ci-cd-test/app/css/app.css";
    @import "/anywhere-ui-ci-cd-test/assets/css/anywhere-flex.css";
    :host {
        display: block;
    }
    .layout-config {
                ...
                <div class="grid free-themes">
                    <div class="col-3">
                        <button class="any-link" data-select-theme="anywhere-default">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/anywhere-default-violet.png" alt="Adaleks Violet" />
                        </button>
                        <span>Violet</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="anywhere-default-light-purple">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/anywhere-light-purple.png" alt="Adaleks Light Purple" />
                        </button>
                        <span>Purple</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="anywhere-default-dark-violet">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/anywhere-dark-violet.png" alt="Adaleks Dark Violet" />
                        </button>
                        <span>Violet</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="anywhere-default-dark-purple">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/anywhere-dark-purple.png" alt="Adaleks Dark Purple" />
                        </button>
                        <span>Purple</span>
                    </div>
                </div>
                ...
                <div class="grid free-themes">
                    <div class="col-3">
                        <button class="any-link" data-select-theme="bootstrap4-light-blue">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/bootstrap4-light-blue.svg" alt="Bootstrap Light Blue" />
                        </button>
                        <span>Blue</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="bootstrap4-light-purple">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/bootstrap4-light-purple.svg" alt="Bootstrap Light Purple" />
                        </button>
                        <span>Purple</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="bootstrap4-dark-blue">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/bootstrap4-dark-blue.svg" alt="Bootstrap Dark Blue" />
                        </button>
                        <span>Blue</span>
                    </div>
                    <div class="col-3">
                        <button class="any-link" data-select-theme="bootstrap4-dark-purple">
                            <img src="/anywhere-ui-ci-cd-test/assets/images/themes/bootstrap4-dark-purple.svg" alt="Bootstrap Dark Purple" />
                        </button>
                        <span>Purple</span>
                    </div>
                </div>
